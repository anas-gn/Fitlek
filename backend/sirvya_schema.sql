...
CREATE TABLE `messages` (
  ...
  `mediaUrl` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mediaType` enum('text','image','audio') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
  `mediaExpired` tinyint(1) NOT NULL DEFAULT '0',
