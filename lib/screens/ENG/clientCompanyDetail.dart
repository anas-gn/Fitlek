  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final results = await Future.wait([
        http.get(Uri.parse('$baseUrl/advisors'), headers: _headers),
        http.get(
          Uri.parse('$baseUrl/advisors/${widget.advisorId}/coaches'),
          headers: _headers,
        ),
        http.get(
          Uri.parse('$baseUrl/advisors/${widget.advisorId}/images'),
          headers: _headers,
        ),
      ]);
