  ...
  Widget _buildSummaryCard() {
    ...
    child: Row(children: [
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('Total Earned Points', style: TextStyle(color: cs.onPrimary.withValues(alpha: 0.75), fontSize: 12, fontWeight: FontWeight.w600, letterSpacing: 0.3)),
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
        Text('${_invitations.length}', style: TextStyle(color: cs.onPrimary, fontSize: 42, fontWeight: FontWeight.w900, height: 1)),
        Text('total invites', style: TextStyle(color: cs.onPrimary.withValues(alpha: 0.6), fontSize: 12, fontWeight: FontWeight.w600)),
      ]),
    ]),
  );
  }
      ...
      Row(children: [
        ...
        if (inv['status'] != 'pending')
          Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
            ...
            child: Text(
              inv['status'] == 'accepted' ? '+${inv['pointsEarned']} pts' : 'Declined',
